...
def test_doc_kepler():
    ...
    assert np.allclose(curva_min(amostragem,'years')[0:5], [0., 0.15783305, 0.44541954, 0.81721102, 1.25700057], atol=1e-2)
    assert np.allclose(curva_max(amostragem,'years')[0:5], [0., 0.17670968, 0.4994268, 0.91709789, 1.41152222], atol=1e-2)

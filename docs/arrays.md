...
```py
--8<-- "tests/doctest/test_doc_operacoes_basicas_arrays.py:operacoes_arrays"
```
...
```py 
--8<-- "tests/doctest/test_doc_linspace.py:linspace"
```
...
```py 
--8<-- "tests/doctest/test_doc_linspace.py:arraym"
```
